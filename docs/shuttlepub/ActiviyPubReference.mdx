...
URLが`@user/id` になってない部分とかがmastodonとは違うことがよくわかる。ちなみにmastodonから見たときは`https://social.vivaldi.net/@momosetkn@misskey.dev/109818573742231014`みたく数字idになる。[これどっから来たの....](reference.mdx#記事URL)
